...
def standardize_weather_cols(data: pd.DataFrame, country: str) -> pd.DataFrame:
    ...
    if country.lower() != "usa":
        ...
        json_path = os.path.join(
            DATA_DIR, "khaki_corn_belt", "weekly_weather_param_scalers.json"
        )
...
def read_usa_dataset_weathermodel(data_dir: str):
...
def read_non_us_dataset_weathermodel(data_dir: str, country: str):
    full_filename = f"khaki_corn_belt/khaki_{country}_multi_crop.csv"
...
def get_train_test_loaders_weathermodel(
